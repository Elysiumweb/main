  ...
  privacy: {
    ...
    body: (
      <>
        ...
        <P>Les contenus et services tiers suivants ne sont chargés qu'après votre consentement explicite (bandeau de consentement, « Gérer mes choix » dans le pied de page) :</P>
        <P>• <strong>Twitch</strong> (player.twitch.tv) : lecteur du stream officiel sur la page d'accueil. Déposé uniquement si la catégorie « Contenus sociaux » est acceptée.<br />• <strong>YouTube</strong> (youtube-nocookie.com / youtube.com) : lecteurs des replays sur l'accueil et la médiathèque, dans la même catégorie.<br />• <strong>Discord</strong> (discord.com/api) : compteurs « en ligne / membres » affichés sur l'accueil. Aucun appel à l'API Discord avant consentement.<br />• <strong>Polices web</strong> : Orbitron et Rajdhani sont auto-hébergées (aucune requête externe). En secours uniquement, si les fichiers locaux sont absents, le chargement depuis Google Fonts nécessite votre accord dans la catégorie « Polices web ».</P>
        <P>La mesure d'audience du site est interne à Elysium (aucun tiers) et n'est activée qu'avec votre accord (catégorie « Mesure d'audience »).</P>
        <P>Seules les sections de don chargent le module de paiement PayPal, qui peut déposer ses propres cookies techniques et anti-fraude lors de son affichage, sans lien avec votre choix de consentement.</P>
        <H>Vos droits</H>
