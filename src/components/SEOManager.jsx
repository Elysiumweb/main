...
const routeSEO = [
  ...
  { path: "/offline", title: "Hors ligne — ELYSIUM Esport", description: "Vous êtes hors ligne. La page se rechargera automatiquement dès le retour de la connexion.", noIndex: true },
